...
<body class="fondbody">
	...
	<?php include("admin_navbar.php"); ?><!--	  navbar-->
						...
						<div class="card mt-1">
							<div class="card-body">
									...
									<div class="form-group">
										...
										{
											echo '<option value="'.$ligne_client['id_client'].'">'.$ligne_client['nom'].' '.$ligne_client['om'].'</option>';
										}
										?>
									</select>
									</div>
		...
		<form action="modification_client.php" method="POST" name="modification_client.php">
			<div class="form-row aliceblue p-1">
				<div class="form-group col-xl-3 col-md-6">
							<label for="nom">Nom de famille</label>
							<input type="text" name="nom" value="<?php echo $ligne_modif_client['nom']; ?>" class="form-control form-control-sm">
				</div><!--fin form group col 3-->
				<div class="form-group col-xl-3 col-md-6">
						<label for="prenom">Prénom</label>
						<input type="text" name="prenom" value="<?php echo $ligne_modif_client['prenom']; ?>" class="form-control form-control-sm">
				</div><!--fin form group col 3-->
				<div class="form-group col-xl-3 col-md-6">
						<label for="email">Courriel</label>
						<input type="text" name="email" value="<?php echo $ligne_modif_client['email']; ?>" class="form-control form-control-sm">
				</div><!--fin form group col 3-->
				...
				<div class="form-group col-xl-3 col-md-6">
						...
						<input type="text" name="motdepasse" value="<?php echo $ligne_modif_client['motdepasse']; ?>" class="form-control form-control-sm">
				</div><!--fin form group col 3-->
				
				<div class="col-xl-9 col-md-6">&nbsp;</div><!--fin form group col 9-->
				<div class="form-group col-xl-3 col-md-6">
						<label for="tel">Téléphone</label>
						<input type="text" name="tel" value="<?php echo $ligne_modif_client['tel']; ?>" class="form-control form-control-sm">
				</div><!--fin form group col 3-->
				<div class="form-group col-xl-3 col-md-6">
						<label for="portable">Portable</label>
						<input type="text" name="portable" value="<?php echo $ligne_modif_client['portable']; ?>" class="form-control form-control-sm">
				</div><!--fin form group col 3-->
				...
				<div class="form-group col-xl-2 col-md-6">
						...
						<select name="paysCB" class="form-control form-control-sm">>
								...
								<?php
								foreach($pdoDEBUG->query("SELECT id_paysCB, paysCBFR FROM t_payscb ORDER BY tpaysCBFR ASC") as $ligne_paysCB)
								{
